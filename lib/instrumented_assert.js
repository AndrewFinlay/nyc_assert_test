...
function cov_2amnin3uud() {
    var path = "nycAssert/lib/assert.js";
    var hash = "a76c2b788bcb22dfc02384bfaeeb97fe2eb7c850";
    var global = new Function("return this")();
    var gcv = "__coverage__";
    var coverageData = {
        path: "nycAssert/lib/assert.js",
        statementMap: {
            "0": {
                start: {
                    line: 3,
        ...
        hash: "a76c2b788bcb22dfc02384bfaeeb97fe2eb7c850"
    };
    ...
    cov_2amnin3uud = function() {
        return actualCoverage;
    };
    return actualCoverage;
}
const assert = (cov_2amnin3uud().s[0]++, require('assert')); // nyc bug here
/**
...
const assertFn = (condition, message) => {
    ...
    try {
        ...
        const err = (cov_2amnin3uud().s[4]++, e instanceof Error ? (cov_2amnin3uud().b[0][0]++, e) : (cov_2amnin3uud().b[0][1]++, new Error(e)));
        cov_2amnin3uud().s[5]++;
